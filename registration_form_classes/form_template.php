        ...
        <form action="index.php" method="POST">
            ...
            <div class="form-group">
                ...
                <select name="topic">
                    ...
                    <?php 
                    $topics = ['Бизнес', 'Технологии', 'Реклама и Маркетинг'];
                    foreach($topics as $t): ?>
                        <option value="<?= e($t) ?>" <?= ($formData['topic'] ?? '') == $t ? 'selected' : '' ?>>
                            <?= e($t) ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="form-group">
                ...
                <?php 
                $methods = ['WebMoney', 'Яндекс.Деньги', 'PayPal', 'Кредитная карта'];
                foreach($methods as $m): ?>
                    <label style="font-weight: normal;">
                        <input type="radio" name="payment" value="<?= e($m) ?>" 
                               <?= ($formData['payment'] ?? '') == $m ? 'checked' : '' ?>> 
                        <?= e($m) ?>
                    </label>
                <?php endforeach; ?>
            </div>
