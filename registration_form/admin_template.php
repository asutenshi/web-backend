    ...
    <?php else: ?>
        <form action="admin.php" method="POST">
            <table>
                ...
                <tbody>
                    <?php foreach ($requestsData as $req): ?>
                        <tr>
                            <td>
                                <input type="checkbox" name="to_delete[]" value="<?= e($req['filename']) ?>">
                            </td>
            ...
            <br>
            <button type="submit" name="delete_files" onclick="return confirm('Вы уверены, что хотите удалить выбранные заявки?')">
                Удалить выбранные
            </button>
        </form>
    <?php endif; ?>
